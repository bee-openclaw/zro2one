...
|---|---|---|
| **ChatGPT** (chat.openai.com) | General purpose, most popular | Yes — GPT-4o-mini, limited GPT-4o |
| **Claude** (claude.ai) | Long documents, nuanced writing | Yes — generous free tier |
| **Gemini** (gemini.google.com) | Google integration, recent information | Yes — connected to Google |

...
date: "2026-03-23"
readTime: 8
description: "A practical guide for freelancers who want to use AI to punch above their weight — covering client work, proposals, admin, and building a one-person operation that feels like a team."
related: [getting-started-ai-at-work-safely, getting-started-ai-for-small-business, getting-started-building-ai-habits]
---
...
1. Save your best client emails as templates
2. For each new email, give AI the context (project status, client personality, what needs communicating) and let it draft
3. Review, adjust tone, send
...
1. Keep a running list of topics (things clients ask, problems you solve, opinions you have)
2. Weekly: pick one topic, brain-dump your actual thoughts (voice memo works great)
3. Feed the brain-dump to AI: "Turn this into a LinkedIn post / blog post / newsletter. Match this tone: [example of your writing]."
4. Edit for accuracy and personality. Publish.
...
1. **A good AI chat tool** — ChatGPT, Claude, or Gemini. Pick one and learn it well. The best tool is the one you actually use.
2. **A voice transcription tool** — for turning thoughts into text quickly. Many AI assistants do this natively.
3. **An automation tool** (optional) — Zapier or Make.com to connect AI to your other tools (email → AI draft → review queue).
